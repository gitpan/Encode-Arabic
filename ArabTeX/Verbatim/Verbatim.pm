...
__PACKAGE__->Define('arabtex-verbatim', 'ArabTeX-Verbatim', 'arabtex-verb', 'ArabTeX-Verb');
...
Encode::Arabic::ArabTeX::Verbatim - Interpreting the Arabic script using the ArabTeX verbatim notation
...
=head1 SYNOPSIS
    ...
    while ($line = <>) {                    # maps the ArabTeX notation for Arabic into the Arabic script
        ...
        print encode 'utf8', decode 'arabtex-verb', $line;      # 'arabtex-verb' alias 'ArabTeX-Verbatim'
    }
